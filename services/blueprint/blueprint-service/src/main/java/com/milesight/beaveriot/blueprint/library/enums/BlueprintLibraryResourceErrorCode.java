...
public enum BlueprintLibraryResourceErrorCode implements ErrorCodeSpec {
    ...
    BLUEPRINT_LIBRARY_RESOURCE_DEVICES_NOT_FOUND(HttpStatus.NOT_FOUND.value(),
            "blueprint_library_resource_devices_not_found", "Blueprint library resource devices not found for vendor '{0}'"),
    BLUEPRINT_LIBRARY_RESOURCE_DEVICE_NOT_FOUND(HttpStatus.NOT_FOUND.value(),
            "blueprint_library_resource_device_not_found", "Blueprint library resource device not found for vendor '{0}' and model {1}"),
