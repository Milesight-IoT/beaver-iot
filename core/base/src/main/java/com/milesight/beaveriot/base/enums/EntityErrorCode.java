...
public enum EntityErrorCode implements ErrorCodeSpec {
    ...
    ENTITY_NAME_NULL(HttpStatus.BAD_REQUEST.value(), "entity_name_null",
            "entity {0} name must not be null"),
    ...
    ENTITY_ATTACH_ID_NULL(HttpStatus.BAD_REQUEST.value(), "entity_attach_id_null",
            "entity {0} attach id must not be null"),
    ...
    ENTITY_ATTRIBUTE_MIN_GREATER_THAN_MAX(HttpStatus.BAD_REQUEST.value(), "entity_attribute_min_greater_than_max",
            "entity {0} attribute min {1} greater than max {2}"),
    ...
    ENTITY_ATTRIBUTE_MIN_LENGTH_GREATER_THAN_MAX_LENGTH(HttpStatus.BAD_REQUEST.value(), "entity_attribute_min_length_greater_than_max_length",
            "entity {0} attribute min length {1} greater than max length {2}"),
