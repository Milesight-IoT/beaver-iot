...
public class DemoIntegrationEntities extends ExchangePayload {
    ...
    // Service Samples
    @Entity(type = EntityType.SERVICE, attributes = @Attribute(unit = "m", max = 1, min = 0, enumClass = DeviceStatus.class, required = false))
    private String entitySync;
    @Entity(type = EntityType.SERVICE, attributes = @Attribute(required = false))
